...
class UserCanByEnterpriseMiddleware
{
    ...
    */
    ...
    private function checkPermission($_request) {
        $getMethods    = array('processo.buscar', 'processo.listarDocumentos', 'processo.acessarDocumento', 'processo.upload');
        $posttMethods  = array('processo.listarRegistros', 'processo.documento.aprovar', 'processo.documento.rejeitar', 'processo.realizarUpload');
