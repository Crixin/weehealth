...
use App\{Processo, Empresa, EmpresaProcesso, User};
use App\Repositories\{EmpresaGrupoRepository, EdicaoDocumentoRepository, EmpresaProcessoGrupoRepository, GrupoUserRepository};
...
class ProcessoController extends Controller
{
    ...
    */
    ...
    public function updateProcess(Request $request)
    {
        ...
        if($request->get('nome') != $processo->nome) $arrRegras['nome'] = 'required|string|max:100|unique:processo';
