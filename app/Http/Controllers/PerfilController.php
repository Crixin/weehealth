...
use App\Repositories\{PerfilRepository, PermissaoRepository, PerfilPermissaoRepository};
...
class PerfilController extends Controller
{
    ...
    public function __construct(PerfilRepository $perfil, PermissaoRepository $permissao, PerfilPermissaoRepository $perfilPermissao)
    {
