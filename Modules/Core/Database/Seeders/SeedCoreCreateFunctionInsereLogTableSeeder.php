...
class SeedCoreCreateFunctionInsereLogTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $teste = '$BODY$';
        DB::unprepared(
            "CREATE FUNCTION public.inserelog(IN tabela character varying, IN coluna character varying, IN chave character varying, IN operacao character varying, IN valor_velho character varying, IN valor_novo character varying, IN obs character varying DEFAULT ''::character varying)
                RETURNS void
                LANGUAGE 'plpgsql'
            ...
            AS $teste
            begin
                if valor_velho <> valor_novo then
                Insert into core_log (usuario, tabela, coluna, chave, operacao, valor_velho, valor_novo, obs, created_at, updated_at)
                    Values (
                            Upper(Current_User),
                            tabela,
                            coluna,
