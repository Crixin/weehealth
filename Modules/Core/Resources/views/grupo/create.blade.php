...
@section('page_title', __('page_titles.core.group.create'))
...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"> @lang('page_titles.core.group.create') </li>    
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('core.grupo.salvar') }}">
                    {{ csrf_field() }}
                    <div class="form-body">
