...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"> @lang('page_titles.dashboard.update') </li>    
@endsection
...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('dashboards.alterar') }}" id="updateDashboard" name="updateDashboard" >
                {{ csrf_field() }}
