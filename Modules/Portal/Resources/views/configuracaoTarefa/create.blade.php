...
@section('page_title', __('page_titles.configuracaoTarefa.create'))
...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active"> @lang('page_titles.configuracaoTarefa.create') </li>    
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('config-tarefa.salvar') }}">
                    {{ csrf_field() }}
                    <div class="form-body">
