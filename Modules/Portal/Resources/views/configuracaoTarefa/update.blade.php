...
@section('page_title', __('page_titles.configuracaoTarefa.update'))


@section('breadcrumbs')

    <li class="breadcrumb-item"><a href="{{ route('home') }}"> @lang('page_titles.general.home') </a></li>
    <li class="breadcrumb-item"><a href="{{ route('config-tarefa') }}"> @lang('page_titles.configuracaoTarefa.index') </a></li>
    <li class="breadcrumb-item active"> @lang('page_titles.configuracaoTarefa.update') </li>    
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('config-tarefa.alterar') }}">
                    {{ csrf_field() }}
                <input type="hidden" name="idConfiguracao" value="{{ $configuracao->id }}">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('nome') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="nome" name="nome" value="{{ $configuracao->nome }}" class="form-control" required autofocus>
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('tipoConfiguracao') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control selectpicker" name="tipoConfiguracao" id="tipoConfiguracao" required>
                                        <option value="FTP" {{$configuracao->tipo == 'FTP' ? 'selected' : ''}} >FTP</option>
                                        <option value="PASTA_SERVIDOR" {{$configuracao->tipo == 'PASTA_SERVIDOR' ? 'selected' : ''}} >Pasta do Sistema</option>
                                    </select>
                        ...
                        <div class="row" id="divPastaSistema" style="display: none">
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('pastaSistema') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="pastaSistema" name="pastaSistema" value="{{ $configuracao->caminho }}" class="form-control" >
                        ...
                        <div class="row" id="divFTP" style="display: none">
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('ip') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="ip" name="ip" value="{{ $configuracao->ip }}" class="form-control ip_address" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('porta') ? ' has-error' : '' }}">
                                    ...
                                    <input type="number" min="1" id="porta" name="porta" value="{{ $configuracao->porta }}" class="form-control" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('usuario') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" id="usuario" name="usuario" value="{{ $configuracao->usuario }}" class="form-control " >
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('senha') ? ' has-error' : '' }}">
                                    ...
                                    <div class="input-group">
                                        <input type="password" id="senha" name="senha" value="{{ $configuracao->senha }}" class="form-control " >
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('config-tarefa') }}" class="btn btn-inverse"> @lang('buttons.general.back')</a>
                    </div>
