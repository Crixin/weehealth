...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item"><a href="{{ route('docs.fluxo.etapa', ['fluxo_id' => $fluxo->id]) }}"> @lang('page_titles.docs.etapa-fluxo.index') </a></li>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('docs.fluxo.etapa.salvar', ['fluxo_id' => $fluxo->id]) }}"> 
                    {{ csrf_field() }}
                    ...
                    <div class="form-actions ">
                        ...
                        <a href="{{ route('docs.fluxo.etapa', ['fluxo_id' => $fluxo->id]) }}" class="btn btn-inverse"> @lang('buttons.general.back')</a>
                    </div>
                </form>
