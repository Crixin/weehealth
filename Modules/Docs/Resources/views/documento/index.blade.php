    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open(['method' => 'POST', 'route' => 'docs.documento.iniciar-revisao', 'class' => 'form-horizontal', 'id' => 'submit-iniciar-revisao' ]) !!}
                    {!! Form::hidden('documento', 'value', ['id' => "documento-revisao"]) !!}
                {!! Form::close() !!}
            </div>
        </div>
    </div>
...
@section('footer')
    ...
    <script>
        ...
        $('.documento-iniciar-revisao').click(function(){
            ...
            let iniciarRevisao = swal2_warning("Deseja iniciar a revisão do documento!", "Sim Iniciar!");

            iniciarRevisao.then(resolvedValue => {
                $("#documento-revisao").val(documento);
                $("#submit-iniciar-revisao").submit();
