...
@section('page_title', __('page_titles.docs.plano.index'))


@section('breadcrumbs')

    <li class="breadcrumb-item"><a href="{{ route('docs.home') }}"> @lang('page_titles.general.home') </a></li>
    <li class="breadcrumb-item active"> @lang('page_titles.docs.plano.index') </li>    
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <a href="{{ route('docs.plano.novo') }}" class="btn waves-effect waves-light  btn-success pull-right"><i class="fa fa-pencil"></i>&nbsp;@lang('buttons.docs.plano.create') </a>
                    </div>
    ...
    <script>
        ...
        $('.sa-warning').click(function(){
            ...
            deleteIt.then(resolvedValue => {
                ...
                ajaxMethod('POST', "{{ URL::route('docs.plano.deletar') }}", obj).then(response => {
                    if(response.response != 'erro') {
                        swal2_success("Excluído!", "Plano excluído com sucesso.");
                    } else {
                        swal2_alert_error_support("Tivemos um problema ao excluir o plano.");
                    }
                }, error => {
                    console.log(error);
                });
